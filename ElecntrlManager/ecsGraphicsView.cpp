...
void ecsGraphicsView::setupUI() {
    ...
    QAction* makeGotoMinimumn = new QAction(
            ecsManagerApp::inst()->actionIcons[ecsManager::a_GOTO_MINIMUM],
            tr("Go To Minimum"), this
            );
    ...
    makeGotoMinimumn->setData( ecsManager::a_GOTO_MINIMUM );
    ...
    ecsGraphicsActionMenu->addAction( makeGotoMinimumn );
    ...
    QAction* makeTripleClick = new QAction(
            ecsManagerApp::inst()->eventIcons[ecsManager::e_KEY_TRIPLECLICKED],
            tr("Triple Click"), this
            );
    ...
    ecsGraphicsEventMenu->addAction( makeTripleClick );
